...
/* ============================================================
   ...
   ============================================================ */
const PLANTA_EXTRA = {
  tomate:        { m2: 0.40, rendimiento: '3–5 kg por planta. Con 2 plantas, tomates para 2 personas todo el verano.', modo_siembra: 'unidad', densidad: 2, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 7 },
  pimiento:      { m2: 0.35, rendimiento: '1–2 kg por planta. Una planta produce pimientos durante 4 meses.', modo_siembra: 'unidad', densidad: 3, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 14 },
  berenjena:     { m2: 0.50, rendimiento: '8–15 frutos por planta durante todo el verano.', modo_siembra: 'unidad', densidad: 2, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 14 },
  calabacin:     { m2: 0.70, rendimiento: '1 planta produce abundantemente; con 2 m² tienes calabacines para toda la familia.', modo_siembra: 'unidad', densidad: 1, metodo: 'directo', profundidad_cm: 2, germinacion_dias: 7 },
  pepino:        { m2: 0.25, rendimiento: '10–20 pepinos por planta en una temporada.', modo_siembra: 'unidad', densidad: 2, metodo: 'semillero', profundidad_cm: 1, germinacion_dias: 7 },
  lechuga:       { m2: 0.06, rendimiento: '1 cabeza cada 6 semanas. Sembrando en tandas, cosecha continua.', modo_siembra: 'unidad', densidad: 8, metodo: 'semillero', profundidad_cm: 0.3, germinacion_dias: 7 },
  espinaca:      { m2: 0.04, rendimiento: 'Hojas frescas en 40 días. Varias cosechas por ciclo.', modo_siembra: 'hilera', densidad: 33, metodo: 'directo', profundidad_cm: 1, germinacion_dias: 10 },
  zanahoria:     { m2: 0.01, rendimiento: '1 zanahoria por planta. En 30 cm de hilera, 10–15 zanahorias.', modo_siembra: 'hilera', densidad: 60, metodo: 'directo', profundidad_cm: 1, germinacion_dias: 14 },
  radano:        { m2: 0.01, rendimiento: 'El más rápido: cosecha en 25 días. En 0,1 m² obtienes 20–30 rábanos.', modo_siembra: 'hilera', densidad: 110, metodo: 'directo', profundidad_cm: 1, germinacion_dias: 5 },
  cebolla:       { m2: 0.02, rendimiento: '1 cebolla por bulbillo. En 1 m², más de 50 cebollas.', modo_siembra: 'hilera', densidad: 33, metodo: 'semillero', profundidad_cm: 1, germinacion_dias: 10 },
  ajo:           { m2: 0.01, rendimiento: '1 cabeza por diente plantado. En 0,5 m², 30–40 cabezas de ajo.', modo_siembra: 'hilera', densidad: 50, metodo: 'bulbo', profundidad_cm: 3, germinacion_dias: 14 },
  puerro:        { m2: 0.03, rendimiento: '1 puerro por planta. Lento pero muy abundante por metro cuadrado.', modo_siembra: 'hilera', densidad: 16, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 14 },
  brocoli:       { m2: 0.50, rendimiento: '1 cabeza central + numerosas yemas laterales durante semanas.', modo_siembra: 'unidad', densidad: 2, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 7 },
  acelga:        { m2: 0.07, rendimiento: 'Cosecha de hojas durante meses. 1 planta alimenta semanalmente.', modo_siembra: 'unidad', densidad: 6, metodo: 'directo', profundidad_cm: 1, germinacion_dias: 10 },
  judia_verde:   { m2: 0.08, rendimiento: '200–300 g por planta. En 1 m², varios kg durante el verano.', modo_siembra: 'unidad', densidad: 4, metodo: 'directo', profundidad_cm: 3, germinacion_dias: 7 },
  guisante:      { m2: 0.05, rendimiento: '100–200 g por planta. Varias cosechas en primavera.', modo_siembra: 'hilera', densidad: 8, metodo: 'directo', profundidad_cm: 3, germinacion_dias: 10 },
  fresa:         { m2: 0.10, rendimiento: '200–400 g por planta. En primavera y otoño con variedades remontantes.', modo_siembra: 'unidad', densidad: 8, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  tomate_cherry: { m2: 0.25, rendimiento: 'Cientos de frutos por planta. Ideal para balcones pequeños.', modo_siembra: 'unidad', densidad: 2, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 7 },
  arandano:      { m2: 0.40, rendimiento: '1–3 kg por arbusto a partir del 2.º año. Producción durante 20 años.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  albahaca:      { m2: 0.04, rendimiento: 'Hojas frescas toda la temporada si se poda regularmente.', modo_siembra: 'mata', unidades_sugeridas: 2, metodo: 'semillero', profundidad_cm: 0.3, germinacion_dias: 7 },
  perejil:       { m2: 0.03, rendimiento: 'Cosecha continua de hojas durante todo el año en climas suaves.', modo_siembra: 'mata', unidades_sugeridas: 2, metodo: 'directo', profundidad_cm: 0.5, germinacion_dias: 21 },
  romero:        { m2: 0.20, rendimiento: 'Perenne: ramitas todo el año durante décadas.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  tomillo:       { m2: 0.15, rendimiento: 'Perenne: cosecha continua, especialmente aromático antes de florecer.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  menta:         { m2: 0.10, rendimiento: 'Muy productiva: hojas frescas de primavera a otoño cada año.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  oregano:       { m2: 0.10, rendimiento: 'Perenne muy aromático. Una planta cubre las necesidades de cocina.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  pimiento_padron: { m2: 0.35, rendimiento: '1–2 kg por planta. Una planta da pimientos de padrón durante todo el verano.', modo_siembra: 'unidad', densidad: 3, metodo: 'semillero', profundidad_cm: 0.5, germinacion_dias: 14 },
  haba:          { m2: 0.06, rendimiento: '300–500 g por planta. En 1 m², varios kg de habas frescas en primavera.', modo_siembra: 'hilera', densidad: 8, metodo: 'directo', profundidad_cm: 3, germinacion_dias: 10 },
  patata:        { m2: 0.20, rendimiento: '500 g–1,5 kg por planta. En un saco de 50L, 2–4 kg de patatas.', modo_siembra: 'unidad', densidad: 5, metodo: 'patata', profundidad_cm: 7, germinacion_dias: 21 },
  calabaza:      { m2: 1.00, rendimiento: '2–4 frutos por planta. Un fruto puede pesar 3–8 kg.', modo_siembra: 'unidad', densidad: 1, metodo: 'directo', profundidad_cm: 3, germinacion_dias: 10 },
  freson:        { m2: 0.12, rendimiento: '300–600 g por planta. Frutos grandes en primavera.', modo_siembra: 'unidad', densidad: 8, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  frambuesa:     { m2: 0.30, rendimiento: '1–2 kg por planta a partir del 2.º año. Cosecha en verano y otoño.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  sandia:        { m2: 1.00, rendimiento: '1–2 frutos por planta. Variedades mini: frutos de 2–4 kg.', modo_siembra: 'unidad', densidad: 1, metodo: 'semillero', profundidad_cm: 1, germinacion_dias: 7 },
  melon:         { m2: 0.80, rendimiento: '2–3 frutos por planta. Cada melón pesa 1–3 kg.', modo_siembra: 'unidad', densidad: 1, metodo: 'semillero', profundidad_cm: 1, germinacion_dias: 7 },
  higo:          { m2: 0.50, rendimiento: '3–8 kg por árbol a partir del 3.er año. Producción durante décadas.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  limon:         { m2: 0.40, rendimiento: '30–80 limones por árbol en maceta. Floración casi continua.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  granada:       { m2: 0.50, rendimiento: '5–15 kg por arbusto maduro. Las granadas se conservan meses.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  mora:          { m2: 0.30, rendimiento: '2–4 kg por planta al año. Muy productiva sin apenas cuidados.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  cilantro:      { m2: 0.03, rendimiento: 'Hojas frescas en 30 días. Sembrar en tandas para cosecha continua.', modo_siembra: 'mata', unidades_sugeridas: 3, metodo: 'directo', profundidad_cm: 0.5, germinacion_dias: 10 },
  hierbabuena:   { m2: 0.10, rendimiento: 'Muy productiva: hojas frescas de primavera a otoño cada año.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 },
  cebollino:     { m2: 0.03, rendimiento: 'Cortar y vuelve a crecer: cosecha continua durante toda la temporada.', modo_siembra: 'mata', unidades_sugeridas: 2, metodo: 'directo', profundidad_cm: 0.5, germinacion_dias: 14 },
  laurel:        { m2: 0.25, rendimiento: 'Perenne: hojas disponibles todo el año durante décadas.', modo_siembra: 'mata', unidades_sugeridas: 1, metodo: 'esqueje', profundidad_cm: 0, germinacion_dias: 0 }
};
