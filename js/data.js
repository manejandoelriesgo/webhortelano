...
/* ============================================================
   ...
   ============================================================ */
const PLANTA_EXTRA = {
  tomate:        { m2: 0.40, rendimiento: '3–5 kg por planta. Con 2 plantas, tomates para 2 personas todo el verano.' },
  pimiento:      { m2: 0.35, rendimiento: '1–2 kg por planta. Una planta produce pimientos durante 4 meses.' },
  berenjena:     { m2: 0.50, rendimiento: '8–15 frutos por planta durante todo el verano.' },
  calabacin:     { m2: 0.70, rendimiento: '1 planta produce abundantemente; con 2 m² tienes calabacines para toda la familia.' },
  pepino:        { m2: 0.25, rendimiento: '10–20 pepinos por planta en una temporada.' },
  lechuga:       { m2: 0.06, rendimiento: '1 cabeza cada 6 semanas. Sembrando en tandas, cosecha continua.' },
  espinaca:      { m2: 0.04, rendimiento: 'Hojas frescas en 40 días. Varias cosechas por ciclo.' },
  zanahoria:     { m2: 0.01, rendimiento: '1 zanahoria por planta. En 30 cm de hilera, 10–15 zanahorias.' },
  radano:        { m2: 0.01, rendimiento: 'El más rápido: cosecha en 25 días. En 0,1 m² obtienes 20–30 rábanos.' },
  cebolla:       { m2: 0.02, rendimiento: '1 cebolla por bulbillo. En 1 m², más de 50 cebollas.' },
  ajo:           { m2: 0.01, rendimiento: '1 cabeza por diente plantado. En 0,5 m², 30–40 cabezas de ajo.' },
  puerro:        { m2: 0.03, rendimiento: '1 puerro por planta. Lento pero muy abundante por metro cuadrado.' },
  brocoli:       { m2: 0.50, rendimiento: '1 cabeza central + numerosas yemas laterales durante semanas.' },
  acelga:        { m2: 0.07, rendimiento: 'Cosecha de hojas durante meses. 1 planta alimenta semanalmente.' },
  judia_verde:   { m2: 0.08, rendimiento: '200–300 g por planta. En 1 m², varios kg durante el verano.' },
  guisante:      { m2: 0.05, rendimiento: '100–200 g por planta. Varias cosechas en primavera.' },
  fresa:         { m2: 0.10, rendimiento: '200–400 g por planta. En primavera y otoño con variedades remontantes.' },
  tomate_cherry: { m2: 0.25, rendimiento: 'Cientos de frutos por planta. Ideal para balcones pequeños.' },
  arandano:      { m2: 0.40, rendimiento: '1–3 kg por arbusto a partir del 2.º año. Producción durante 20 años.' },
  albahaca:      { m2: 0.04, rendimiento: 'Hojas frescas toda la temporada si se poda regularmente.' },
  perejil:       { m2: 0.03, rendimiento: 'Cosecha continua de hojas durante todo el año en climas suaves.' },
  romero:        { m2: 0.20, rendimiento: 'Perenne: ramitas todo el año durante décadas.' },
  tomillo:       { m2: 0.15, rendimiento: 'Perenne: cosecha continua, especialmente aromático antes de florecer.' },
  menta:         { m2: 0.10, rendimiento: 'Muy productiva: hojas frescas de primavera a otoño cada año.' },
  oregano:       { m2: 0.10, rendimiento: 'Perenne muy aromático. Una planta cubre las necesidades de cocina.' },
  pimiento_padron: { m2: 0.35, rendimiento: '1–2 kg por planta. Una planta da pimientos de padrón durante todo el verano.' },
  haba:          { m2: 0.06, rendimiento: '300–500 g por planta. En 1 m², varios kg de habas frescas en primavera.' },
  patata:        { m2: 0.20, rendimiento: '500 g–1,5 kg por planta. En un saco de 50L, 2–4 kg de patatas.' },
  calabaza:      { m2: 1.00, rendimiento: '2–4 frutos por planta. Un fruto puede pesar 3–8 kg.' },
  freson:        { m2: 0.12, rendimiento: '300–600 g por planta. Frutos grandes en primavera.' },
  frambuesa:     { m2: 0.30, rendimiento: '1–2 kg por planta a partir del 2.º año. Cosecha en verano y otoño.' },
  sandia:        { m2: 1.00, rendimiento: '1–2 frutos por planta. Variedades mini: frutos de 2–4 kg.' },
  melon:         { m2: 0.80, rendimiento: '2–3 frutos por planta. Cada melón pesa 1–3 kg.' },
  higo:          { m2: 0.50, rendimiento: '3–8 kg por árbol a partir del 3.er año. Producción durante décadas.' },
  limon:         { m2: 0.40, rendimiento: '30–80 limones por árbol en maceta. Floración casi continua.' },
  granada:       { m2: 0.50, rendimiento: '5–15 kg por arbusto maduro. Las granadas se conservan meses.' },
  mora:          { m2: 0.30, rendimiento: '2–4 kg por planta al año. Muy productiva sin apenas cuidados.' },
  cilantro:      { m2: 0.03, rendimiento: 'Hojas frescas en 30 días. Sembrar en tandas para cosecha continua.' },
  hierbabuena:   { m2: 0.10, rendimiento: 'Muy productiva: hojas frescas de primavera a otoño cada año.' },
  cebollino:     { m2: 0.03, rendimiento: 'Cortar y vuelve a crecer: cosecha continua durante toda la temporada.' },
  laurel:        { m2: 0.25, rendimiento: 'Perenne: hojas disponibles todo el año durante décadas.' }
};
